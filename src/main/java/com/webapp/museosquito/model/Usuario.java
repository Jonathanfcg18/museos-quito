...
public class Usuario {
    ...
    public void setCreadoEn(String c) {
        this.creadoEn = c;
    }
    ...
    public boolean isVisitante() {
        return Rol.VISITANTE.equals(rol);
    }

    public boolean isAdminMuseo() {
        return Rol.ADMIN_MUSEO.equals(rol);
    }

    public boolean isAdminSistema() {
        return Rol.ADMIN_SISTEMA.equals(rol);
    }
