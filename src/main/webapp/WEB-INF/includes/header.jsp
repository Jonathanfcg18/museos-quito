...
<header class="navbar" role="banner">
  ...
  <nav class="navbar-links" id="nav-menu" aria-label="Navegación principal">
    ...
    <c:choose>
      <c:when test="${not empty sessionScope.usuarioSesion}">
        ...
        <span style="color:#fff;opacity:.85;font-size:.85rem;">👤 ${u.nombre}</span>
      ...
      <c:otherwise>
        ...
        <a href="${pageContext.request.contextPath}/login?tab=registro"
           ...
           style="padding:.35rem .9rem;font-size:.85rem;">Registrarse</a>
      </c:otherwise>
    </c:choose>
  ...
  <button class="nav-toggle" onclick="toggleMenuNav()"
