...
<head>
  ...
  <style>
    ...
    body { background: linear-gradient(135deg, #e8ddd0 0%, #f5ede0 50%, #ddd0be 100%); }
    body.dark-mode { background: linear-gradient(135deg, #0f0805 0%, #1a0f0a 50%, #0a0503 100%); }
    ...
    body.dark-mode .portal-brand { color: var(--accent); }
    .portal-brand-icon { font-size: 1.75rem; }
    .portal-brand-title {
    ...
    body.dark-mode .portal-brand-title { color: var(--accent); }
    .portal-brand-sub { font-size: 0.7rem; color: #9a7060; display: block; }
    ...
    body.dark-mode .form-container form { background: #1a0f0a; }
    ...
    body.dark-mode .form-container h1 { color: var(--accent); }
    .form-sub {
      font-size: 0.78rem;
      color: #9a7060;
    ...
    body.dark-mode .auth-input { background: #2a1810; color: #f5edd8; }
    .auth-input::placeholder { color: #b09080; }
    .auth-input:focus { border-color: #7B3A10; background: #fff; }
    body.dark-mode .auth-input:focus { background: #1a0f0a; }

    /* Password wrap en auth */
    .auth-pass-wrap { position: relative; width: 100%; margin: 5px 0; }
    .auth-pass-wrap .auth-input { margin: 0; padding-right: 2.8rem; }
    .auth-pass-toggle {
      position: absolute;
      right: 0.7rem; top: 50%;
    ...
    .auth-alert.err { background: #FFF0F0; color: #B71C1C; border-left: 3px solid #B71C1C; }
    .auth-alert.ok  { background: #EBF5EB; color: #276127; border-left: 3px solid #276127; }

    /* Medidor de contraseña */
    .strength-wrap { width: 100%; margin: 2px 0 4px; display: none; }
    .strength-wrap.visible { display: block; }
    .strength-bars { display: flex; gap: 3px; margin-bottom: 2px; }
    .sbar { height: 3px; flex: 1; border-radius: 2px; background: #e0d0c0; transition: background 0.3s; }
    .sbar.weak   { background: #EF5350; }
    .sbar.fair   { background: #FFA726; }
    .sbar.good   { background: #66BB6A; }
    .sbar.strong { background: #2E7D32; }
    .strength-label { font-size: 0.7rem; color: #9a7060; }
    ...
    body.dark-mode .auth-hint { color: var(--accent); }
    .auth-hint code {
    ...
    .toggle-panel h1 em { font-style: italic; color: #e8c55a; }
    .toggle-panel p {
      font-size: 0.82rem;
    ...
    .btn-toggle:hover { background: rgba(255,255,255,0.15); border-color: #fff; }
    ...
    /* ── Responsive: móvil ── */
    .mobile-toggle-btns { display: none; }
    @media (max-width: 640px) {
      .auth-container { min-height: auto; border-radius: 16px; }
      .toggle-container { display: none; }
      .sign-in, .sign-up { width: 100%; position: relative; }
      .auth-container.active .sign-in  { transform: none; display: none; }
      .auth-container.active .sign-up  { transform: none; opacity: 1; position: relative; }
      .sign-up { display: none; }
      .auth-container.active .sign-up  { display: flex; }
      .mobile-toggle-btns {
      ...
      .mobile-toggle-btns button {
        ...
        cursor: pointer; border: 2px solid #7B3A10;
        background: transparent; color: #7B3A10;
        transition: background 0.2s;
      }
      .mobile-toggle-btns button.active-tab { background: #7B3A10; color: #fff; }
    }
    ...
    body.dark-mode .back-link { color: var(--accent); }
  ...
  <div class="auth-container" id="authContainer">
    ...
    <div class="form-container sign-up">
      <form method="post" action="${pageContext.request.contextPath}/registro"
        ...
        <input type="text" name="nombre" id="regNombre" class="auth-input"
               placeholder="Nombre completo"
               value="${not empty nombreReg ? nombreReg : ''}"/>

        <input type="email" name="email" id="regEmail" class="auth-input"
        ...
        <div class="auth-pass-wrap">
          <input type="password" name="password" id="regPass" class="auth-input"
                 ...
                 oninput="evaluarFuerza()"/>
          <button type="button" class="auth-pass-toggle"
                  onclick="toggleAuthPass('regPass',this)">👁</button>
        </div>
        ...
        <div class="auth-pass-wrap">
          ...
          <button type="button" class="auth-pass-toggle"
                  onclick="toggleAuthPass('regPassConf',this)">👁</button>
        </div>
    ...
    <div class="form-container sign-in">
      <form method="post" action="${pageContext.request.contextPath}/login"
        ...
        <div class="auth-pass-wrap">
          ...
          <button type="button" class="auth-pass-toggle"
                  onclick="toggleAuthPass('loginPass',this)">👁</button>
        </div>
        ...
        <div class="auth-hint">
          ...
          👤 <code>visitante@prueba.ec</code> / <code>Visita2026!</code><br/>
          🏛️ <code>admin.nacional@museos.gob.ec</code> / <code>Admin2026!</code>
        </div>
