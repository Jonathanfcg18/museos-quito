...
<div class="container">
  <div class="confirmacion-box">
    ...
    <div class="confirmacion-nota">
      ...
      <span>Guarda tu código <strong>${reserva.codigoConfirmacion}</strong>.
    ...
    <div class="confirmacion-acciones">
      ...
      <a href="${pageContext.request.contextPath}/reservas/mis-reservas?email=${reserva.emailVisitante}"
