                ...
                <div class="franjas-panel">
                  ...
                  <div class="franjas-lista" id="franjaLista">
                    <c:forEach var="franja" items="${franjas}">
                      <div
                        class="franja-item <c:choose><c:when test='${franja.hayCupos()}'>franja-disponible</c:when><c:otherwise>franja-agotada</c:otherwise></c:choose>"
                        data-fecha="${franja.fecha}" data-id="${franja.id}" data-inicio="${franja.horaInicio}"
                        data-fin="${franja.horaFin}" data-cupos="${franja.cuposDisponibles}"
                ...
                <div class="form-reserva-panel">
                  ...
                  <form method="post" action="${pageContext.request.contextPath}/reservas" id="formReserva"
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Ej: Juan Pérez"
                    ...
                    <div class="form-group">
                      ...
                      <c:if test="${not empty sessionScope.usuarioSesion}">
                        <small class="form-hint">✅ Datos tomados de tu cuenta. Puedes modificarlos si lo deseas.</small>
                      </c:if>
                    </div>
      ...
      <script>
        ...
        (function () {
          ...
          fechas.forEach(function (f) {
            ...
            btn.onclick = function () { filtrarFecha(f, btn); };
