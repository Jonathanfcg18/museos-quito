...
<section class="hero">
  <div class="hero-content">
    ...
    <p>Explora la historia, el arte y la cultura de la capital del Ecuador.<br/>
       Consulta información, horarios y exposiciones. Reserva tu visita en línea.</p>
    <div class="hero-actions">
      ...
      <c:if test="${empty sessionScope.usuarioSesion}">
        <a href="${pageContext.request.contextPath}/login?tab=registro"
           ...
           style="background:rgba(255,255,255,0.15);color:#fff;border:2px solid rgba(255,255,255,0.5);">
          Crear cuenta gratis
        </a>
      </c:if>
    </div>
